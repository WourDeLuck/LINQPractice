...
namespace LINQPractice.Tests
{
    ...
    {
        FluentSyntax fluent = new FluentSyntax();
        List<User> firstList = new List<User>();
        List<User> secondList = new List<User>();
        ...
        [TestMethod]
        public void Fluent_GetUsers_Test()
        {
            var result = fluent.GetUsers(firstList);
        ...
        [TestMethod]
        public void Fluent_GetFullNames_Test()
        {
            var result = fluent.GetFullNames(firstList);
        ...
        [TestMethod]
        public void Fluent_GetUsersInCollections()
        {
            var result = fluent.GetUsersInCollections(firstList, secondList);
        ...
        [TestMethod]
        public void Fluent_GetLastNames_Test()
        {
            var result = fluent.GetLastNames(firstList);
        ...
        [TestMethod]
        public void Fluent_Sort_Test()
        {
            var result = fluent.Sort(firstList);

            Assert.IsNotNull(result);
        }

        [TestMethod]
        public void Fluent_TransformToDictionary_Test()
        {
            var result = fluent.Transform(firstList);
